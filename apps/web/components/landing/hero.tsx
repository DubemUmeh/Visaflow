      ...
      <div className="container-page relative grid gap-12 pb-24 pt-14 lg:grid-cols-[1.1fr_1fr] lg:pb-28 lg:pt-20">
        ...
        >
          <motion.div
            ...
            className="mx-auto mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-border bg-card/75 px-4 py-1.5 text-sm font-medium text-muted-foreground shadow-card backdrop-blur lg:mx-0"
          >
          ...
          <h1 className="text-5xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
            Travel anywhere. <br />
            <span className="gradient-text bg-hero bg-clip-text text-transparent">We handle the visa.</span>
          </h1>
          ...
          <div className="mb-10 mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
            ...
            <Link href="/#how-it-works">
              <Button size="xl" variant="outline" className="w-full bg-card/70 sm:w-auto">
                See How It Works
              </Button>
            </Link>
          </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative overflow-hidden rounded-3xl shadow-elegant ring-1 ring-border/70">
            <img
            ...
            />
            <div className="absolute inset-x-4 bottom-4 rounded-2xl bg-card/85 p-4 shadow-card backdrop-blur">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-wider text-muted-foreground">Avg. approval</p>
          ...
          <div className="absolute -right-4 -top-4 hidden rounded-2xl bg-card p-4 shadow-card ring-1 ring-border/70 lg:block">
            <p className="text-xs text-muted-foreground">Last approval</p>
            <p className="font-medium">France to Japan - 2 min ago</p>
          </div>
        </motion.div>
      </div>

      <div className="absolute bottom-0 left-0 right-0 border-t border-border/70 bg-card/80 backdrop-blur-sm">
