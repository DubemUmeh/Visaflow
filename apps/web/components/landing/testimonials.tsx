...
export function Testimonials() {
  return (
    <section className="py-20 bg-sand/45">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="text-sm font-semibold text-brand uppercase tracking-wider">Trusted by Travelers</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="bg-card rounded-2xl p-6 border border-border/70 shadow-card hover:shadow-soft transition-shadow"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground/70">{t.country}</p>
                </div>
              </div>
            </motion.div>
          ))}
