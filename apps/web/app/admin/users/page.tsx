                ...
                {filtered.length === 0 ? (
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {!user.isActive && <p className="text-xs text-destructive">Inactive</p>}
                          </div>
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          {user.emailVerified && <CheckCircle2 className="w-3.5 h-3.5 text-success flex-shrink-0" />}
                        </div>
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs font-medium ${user.isActive ? 'text-success' : 'text-destructive'}`}>
