    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">{activeCount} active · {countries.length} total</p>
        </div>
              ...
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="font-mono text-xs bg-muted text-muted-foreground px-2 py-1 rounded">{country.code}</span>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className={`h-7 text-xs ${country.isActive ? 'text-destructive hover:bg-destructive/10' : 'text-success hover:bg-success/10'}`}
